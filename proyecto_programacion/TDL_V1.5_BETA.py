...
class Tdl(QMainWindow):
    ...
    def guardar_config(self):
        ...
        try:
            ...
            configuracion_existente = cursor.fetchone()[0]

            if configuracion_existente == 0:
                consulta = f"""INSERT INTO config (tema_elegido,pantalla_completa,volumen)
                                VALUES (%s,%s,%s)"""
                
                configuracion = (self.tema_elegido,int(self.pantalla_completa),self.volumen)

...
3) Realizar un seguimiento regular de tus tareas."""
    ...
    def confirmar_ingresar_tarea(self):
        ...
        descripcion_tarea = self.descripcion_tarea.text()
...
"""
    ...
    def usar_modo_calendario(self):
        if self.overlay_modo_calendario.layout() is None:
            ...
            etiqueta_año = QLabel("Año:")
            aplicar_fade_in(etiqueta_año,1000)
            ...
            layout_calendario.addWidget(etiqueta_mes,1,0)
            layout_calendario.addWidget(self.combobox_meses,1,1)
            layout_calendario.addWidget(etiqueta_año,1,2)
            layout_calendario.addWidget(self.combobox_anios,1,3)
            ...
            layout.addWidget(contenedor_botones)
    ...
    def actualizar_fechas(self):
        ...
        anio_actual=int(self.combobox_anios.currentText())

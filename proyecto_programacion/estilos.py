...
QPushButton {background-color: #E8E00E;
...
#qt_calendar_navigationbar{color: black;
                            background-color: #FAFF24;
                            border: 2px solid #F8FC12;
                            border-radius: 15px;
                            padding: 10px;}
...
QCalendarWidget QToolButton {color: rgba(0,0,0,175);
                            font-family: 'Trebuchet MS';
                            font-size: 20px; }

QCalendarWidget QToolButton:hover {color: rgba(0,0,0,255);
                                    background-color: transparent;}

#qt_calendar_prevmonth:hover,#qt_calendar_nextmonth:hover {background-color: transparent;}

QCalendarWidget QMenu {background-color: #FFFF87;
                        border: 2px solid #F2F244;
                        border-radius: 15px;
                        padding: 10px;
                        color: black;
                        font-size: 16px;}

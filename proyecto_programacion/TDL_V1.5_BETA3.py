...
class Tdl(QMainWindow):
            ...
            if respuesta == QMessageBox.Yes:
                if self.buscar_tareas_duplicadas(nombre_tarea,descripcion_tarea):
                    ...
                    if self.categoria_elegida=="Otro":
                        self.categoria_elegida = self.texto # self.texto viene de self.categoria_otro()
    ...
    def categoria_otro(self):
        ...
        if self.categoria_elegida=="Otro":
            ...
            self.texto=self.texto[0].strip() #devuelve una lista con "texto, true/false"

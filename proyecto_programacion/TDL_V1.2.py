...
"""
    ...
    def usar_modo_calendario(self):
        if self.overlay_modo_calendario.layout() is None:
            ...
            self.boton_ingresar_tarea_modo_calendario.clicked.connect(lambda: self.layout_acciones.setCurrentIndex(1))
            ...
            layout_calendario.addWidget(self.calendario,alignment=Qt.AlignCenter)
            layout_calendario.addWidget(self.label,alignment=Qt.AlignCenter)
